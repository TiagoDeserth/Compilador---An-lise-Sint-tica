...
class Application():
    ...
    def chama_analisador(self):
        ...
        for tok in lexer:
            ...
            elif tok.type == "SE" or tok.type == "SENAO" or tok.type == "ENQUANTO" or tok.type == "PARA" or tok.type == "INTERROMPA" or tok.type == "PROSSIGA" or tok.type == "RETORNE" or tok.type == "EM" or tok.type == "DEFINE" or tok.type == "LEIA" or tok.type == "ESCREVA" or tok.type == "VERDADEIRO" or tok.type == "FALSO" or tok.type == "IFSULDEMINAS" or tok.type == "COMPILADORES" or tok.type == "INICIO" or tok.type == "FIM":
                max = (len(tok.value))
                if (max < 20):
        ...
        if (saidas[2][3] == "COMPILADORES"):
            if (saidas[3][3] != ";"):
                erros += 1
                self.saida.insert('', tk.END, values = "Ops... É necessário a palavra COMPILADORES no início do seu algoritmo!")
            else:
                pass
        else:
            erros += 1
